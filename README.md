...
These errors will appear once for each of the 5 executables inside the workflow as you use new features. Once you have authorized all 5, you won't see these errors anymore until you install a new version.
